 ...
 */
public class RpcServerBootstrap1 {
    private static final Logger logger = LoggerFactory.getLogger(RpcServerBootstrap1.class);

    public static void main(String[] args) {
        String serverAddress = "127.0.0.1:18855";
